...
class VigenereCipher:
    ...
    def get_message_and_key():
        ...
        original_key = original_key.replace(' ', '').upper().strip()  # The key is saved in uppercase sans whitespace
        original_key = original_key.translate(str.maketrans('', '', string.punctuation))
        key = ''
